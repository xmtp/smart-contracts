 ...
 *
 * Usage:
 *   ENVIRONMENT=testnet-dev forge script script/upgrades/SettlementChainParameterRegistryUpgrader.s.sol:SettlementChainParameterRegistryUpgrader --rpc-url base_sepolia --slow --sig "UpgradeSettlementParameterRegistry()" --broadcast
 *
 */
