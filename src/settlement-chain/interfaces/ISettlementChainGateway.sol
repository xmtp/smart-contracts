 ...
 */
interface ISettlementChainGateway is IMigratable, IIdentified, IRegistryParametersErrors {
    /* ============ Events ============ */
     ...
     * @dev    `amountToSend_` (converted to wei) must be greater or equal to the sum of `gasLimit_` multiplied by
