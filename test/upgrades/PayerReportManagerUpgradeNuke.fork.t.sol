...
import {PayerReportManagerNukingMigrator} from "../../src/any-chain/PayerReportManagerNuker.sol";
...
contract PayerReportManagerUpgradeForkTest is Test {
    ...
    function test_payer_report_manager_nuking() external {
        ...
        address oldImpl = deployment.payerReportManagerImplementation;
        ...
        // Deploy migrator
        PayerReportManagerNukingMigrator migrator = new PayerReportManagerNukingMigrator();
        ...
        assertEq(afterImpl, oldImpl, "Implementation updated");
