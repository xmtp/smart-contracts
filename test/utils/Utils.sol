...
contract Utils {
    ...
    function _genRandomInt(uint256 min, uint256 max) internal view returns (uint256 output) {
        return
            min +
    ...
    function _genString(uint32 length) internal pure returns (string memory output) {
